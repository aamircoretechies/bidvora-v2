      ...
      <CardContent className="p-5">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-5">
          <div className="grid gap-1.5">
            ...
            <Input type="number" min={0} value={data?.dailyBidLimit ?? ''} onChange={(e) => onChange?.('dailyBidLimit', parseInt(e.target.value) || 0)} className="w-full" />
          </div>
          <div className="grid gap-1.5">
            ...
            <Input type="number" min={0} value={data?.maxBidsPerCycle ?? ''} onChange={(e) => onChange?.('maxBidsPerCycle', parseInt(e.target.value) || 0)} className="w-full" />
          </div>
          <div className="grid gap-1.5">
            ...
            <Input type="number" min={0} value={data?.maxExistingBids ?? ''} onChange={(e) => onChange?.('maxExistingBids', parseInt(e.target.value) || 0)} className="w-full" />
          </div>
        </div>
      </CardContent>
    </Card>
