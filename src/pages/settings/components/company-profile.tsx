...
const CompanyProfile = () => {
  const statistics = [
    { total: 'Trial', description: 'Status' },
    { total: '10,000', description: 'Query runs' },
    { total: 'Unlimited', description: 'API calls' },
    { total: '$99.00', description: 'Price' },
  ...
  const group: Avatars = [
    ...
    { fallback: '+16', variant: 'text-primary-foreground size-6 ring-background bg-green-500' },
  ];
            ...
            <div className="flex flex-wrap items-center justify-between gap-2">
              <div className="flex flex-col gap-1">
                <div className="flex items-center gap-2.5">
                  <h2 className="text-2xl font-semibold text-mono">Cloud One Enterprise</h2>
                  <Badge size="md" variant="success" appearance="light">Monthly Plan</Badge>
                </div>
            ...
            <div className="flex flex-wrap gap-6 lg:gap-12">
              <div className="flex flex-col gap-3.5 grow">
                <div className="text-sm text-secondary-foreground">
                  Query runs:{' '}
                  <span className="text-sm font-medium text-mono">2239 of 10,000 used</span>
                </div>
              ...
              <div className="flex flex-col gap-2.5 lg:min-w-24 shrink-0 -mt-3 max-w-auto">
                <div className="text-sm font-medium text-secondary-foreground">
                  Seats:{' '}
                  <span className="text-sm font-semibold text-foreground">29 of 120 used</span>
                </div>
